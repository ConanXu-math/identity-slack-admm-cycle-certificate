...
| Exact period-23 route endpoint | route-original terminal bytes and attestation | [`09_counterexample.md`](kimi-period23/research/09_counterexample.md), [`endpoint script`](../provenance/routes/kimi-period23/terminal_artifacts/exp19b_exact_yt.endpoint.py), [`endpoint stdout`](../provenance/routes/kimi-period23/terminal_artifacts/exp19b_exact_yt.stdout.txt), [`run attestation`](../provenance/routes/kimi-period23/run_attestation.json) |
| Hardened route replay | post-hoc verifier hardening of the same dyadic candidate | [`exp19b_exact_yt.py`](kimi-period23/experiments/exp19b_exact_yt.py), [`exp19_certificate.json`](kimi-period23/experiments/results/exp19_certificate.json) |
