...
HALF_CERTIFIER = ROOT / "certify_relaxed_multiplier_half_convergence.py"
DEFAULT_OUTPUT = REPOSITORY_ROOT / "certificates" / "relaxed_multiplier_certificate.json"
DEFAULT_SUMMARY = REPOSITORY_ROOT / "certificates" / "relaxed_multiplier_summary.md"
...
def build_prefix_interval_certificate(
    ...
    initial, _ = half.load_exact_verifier().solve_period_equation(problem)
